"""
Amex Gold Scraper
- Scrapes the benefits of the Amex Gold Card from https://www.americanexpress.com/us/credit-cards/card/gold-card/
    ...
    def scrape(self):
        ...
        try:
            ...
            benefits = self.wait.until(
                EC.presence_of_all_elements_located((By.XPATH, '//*[@id="root"]/div[5]/div/div[2]/div/div/div/div/div[2]/div[6]/div/div/div/section/ul/li'))
            )

            # benefit_items = benefit_ul.find_elements(By.CSS_SELECTOR, "li._listItem_1oy1c_30")
            print("yippety doo")
